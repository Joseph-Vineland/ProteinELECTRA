...
def get_task(config: configure_finetuning.FinetuningConfig, task_name,
  ...
  elif task_name == "secondaryStructure":
    return tagging_tasks.SecondaryStructure(config, tokenizer)
  elif task_name == "fluorescence":
    return classification_tasks.fluorescence(config, tokenizer)
  elif task_name == "remoteHomology":
    return classification_tasks.remoteHomology(config, tokenizer)
  elif task_name == "stability":
    return classification_tasks.stability(config, tokenizer)
  elif task_name == "promoters":
    return classification_tasks.promoters(config, tokenizer)
  else:
